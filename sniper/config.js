const CONFIG_CHAINS = {
    ...
    arbitrum: {
        Kode_Chain: 42161, Nama_Chain: "arbitrum", Nama_Pendek: "arb", URL_Chain: "https://arbiscan.io",
        WARNA:"#a6b0c3", ICON:"https://wiki.dextrac.com:3443/images/1/11/Arbitrum_Logo.png",
        DATAJSON: 'https://monitoring-koin.vercel.app/JSON/arb.json', BaseFEEDEX : "ETHUSDT",
        RPC: 'https://arbitrum-one-rpc.publicnode.com', GASLIMIT: 100000,
        DEXS: [ "1inch", "odos", "kyberswap", "0x", "okx", "lifi" ],
        WALLET_CEX: {
    ...
    ethereum: {
        Kode_Chain: 1, Nama_Chain: "ethereum", Nama_Pendek: "erc", URL_Chain: "https://etherscan.io",
        WARNA:"#8098ee", ICON:"https://icons.iconarchive.com/icons/cjdowner/cryptocurrency-flat/256/Ethereum-ETH-icon.png",
        DATAJSON: 'https://monitoring-koin.vercel.app/JSON/erc.json', BaseFEEDEX : "ETHUSDT",
        RPC: 'https://eth.llamarpc.com', GASLIMIT: 250000,
        DEXS: [ "1inch", "odos", "kyberswap", "0x", "okx", "lifi" ],
        WALLET_CEX: {
    ...
    bsc: {
        Kode_Chain: 56, Nama_Chain: "bsc", Nama_Pendek: "bsc", URL_Chain: "https://bscscan.com",
        WARNA:"#f0af18", ICON:"https://bridge.umbria.network/assets/images/svg/bsc.svg",
        DATAJSON: 'https://monitoring-koin.vercel.app/JSON/bsc.json', BaseFEEDEX : "BNBUSDT",
        RPC: 'https://bsc-dataseed.binance.org/', GASLIMIT: 80000,
        ...
        PAIRDEXS: {
            ...
            "USDC": { symbolPair: "USDC", scAddressPair: "0x8AC76a51cc950d9822D68b83fE1Ad97B32Cd580d", desPair: "18" },
            "BTC": { symbolPair: "BTC", scAddressPair: "0x7130d2a12b9bcbfae4f2634d864a1ee1ce3ead9c", desPair: "18" },
            "ETH": { symbolPair: "ETH", scAddressPair: "0x2170ed0880ac9a755fd29b2688956bd959f933f8", desPair: "18" },
            "NON": { symbolPair: "NON", scAddressPair: "0x", desPair: "18" }
        }
    },
    base: {
        Kode_Chain: 8453, Nama_Chain: "base", Nama_Pendek: "base", URL_Chain: "https://basescan.org/",
        WARNA:"#1e46f9", ICON:"https://avatars.githubusercontent.com/u/108554348?v=4",
        DATAJSON: 'https://monitoring-koin.vercel.app/JSON/base.json', BaseFEEDEX : "ETHUSDT",
        RPC: 'https://base.llamarpc.com', GASLIMIT: 100000,
        DEXS: [ "1inch", "odos", "kyberswap", "0x", "okx", "lifi" ],
        WALLET_CEX: {
...
// Make configs available globally for other scripts
window.CONFIG_CHAINS = window.CONFIG_CHAINS || CONFIG_CHAINS;
window.CONFIG_DEXS = window.CONFIG_DEXS || CONFIG_DEXS;
