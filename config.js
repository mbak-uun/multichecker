...
export const STORAGE_KEYS = {
    SETTINGS: 'MULTIALL_V1_SETTING_SCANNER',
    TOKEN_LIST: 'MULTIALL_V1_TOKEN_SCANNER',
    HISTORY: 'MULTIALL_V1_HISTORY',
    GAS_FEES: 'MULTIALL_V1_ALL_GAS_FEES',
    PRICE_RATE_USDT: 'MULTIALL_V1_PRICE_RATE_USDT'
};
...
// --- CEX, CHAIN, DEX CONFIGURATIONS (from original file) ---
...
export const CONFIG_CEX = {
    ...
    MEXC: {
        ApiKey: "mx0vglBh22wwHBY0il",
        ApiSecret: "429877e0b47c41b68dd77613cdfded64",
        WARNA: "#1448ce",
    },
    INDODAX: {
